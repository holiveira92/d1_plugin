...
<body>
    <?php $url_action = plugins_url('d1_plugin/templates/plataforma/faq_ajax.php','d1_plugin'); ?>
        ...
        <div class="form-style-5" id='secao_content'>
            ...
            foreach ($faqs as $key => &$faq) :
                ...
                <fieldset name="d1_faqs<?php echo D1Plugin::$language; ?>" id_faq="<?php echo $faq['id']; ?>">
                    ...
                    <button id="remove" type="button" name="remove_faq<?php echo D1Plugin::$language; ?>" id_faq="<?php echo $faq['id']; ?>" class="btn_remove_group">Remover</button>
                </fieldset>
                </div>
            <?php endforeach; ?>
            </div>
