...
<label for="secao5_section_descricao">Descrição :</label> <input type="checkbox" name="secao5_section_descricao_degrade"> Para Inserir Degradê, Selecione o Texto e Marque Esta Opção <br><textarea name="secao5_section_descricao" placeholder="Descrição"><?php echo get_option('secao5_section_descricao')?></textarea>
<label for="secao5_link_calcular">Titulo :</label> <input type="text" name="secao5_link_calcular" value="<?php echo get_option('secao5_link_calcular')?>" placeholder="URL Calcular CX">
</fieldset>
</div>
<!-- ------------------------------------- Início Seção Config. Seção - Lead Generator ----------------------------------------------->
