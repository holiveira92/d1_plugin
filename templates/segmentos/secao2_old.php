            ...
            <div class="col form-style-5">
                ...
                ?>  
                    <div class="col form-style-5 middle">
                        <label for="segmentos_secao3_keyp<?php echo $i;?>_title">Título:</label><input type="text" name="segmentos_secao3_keyp<?php echo $i;?>_title<?php echo D1Plugin::$language; ?>" value="<?php echo get_option_esc("segmentos_secao3_keyp".$i."_title") ?>" placeholder="Título">
                        <label for="segmentos_secao3_keyp<?php echo $i;?>_desc">Descrição:</label> <textarea name="segmentos_secao3_keyp<?php echo $i;?>_desc<?php echo D1Plugin::$language; ?>" placeholder="Descrição"><?php echo get_option_esc("segmentos_secao3_keyp".$i."_desc") ?></textarea>
