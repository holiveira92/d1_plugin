        ...
        <div class="row">
            <div class="col form-style-5">
                <fieldset>
                    ...
                    <label for="jornada_secao4_slide_title">Titulo:</label><input type="text" name="jornada_secao4_slide_title" value="<?php echo get_option_esc('jornada_secao4_slide_title'); ?>" placeholder="Titulo">
                    <label for="jornada_secao4_slide_link">Link Slide:</label><input type="text" name="jornada_secao4_slide_link" value="<?php echo get_option_esc('jornada_secao4_slide_link'); ?>" placeholder="Link Slide">
                    <label for="jornada_secao4_slide_code">Código iframe Slide:</label> <textarea name="jornada_secao4_slide_code" placeholder="Codigo ifram Slide" rows='7'><?php echo get_option_esc('jornada_secao4_slide_code'); ?></textarea>
                </fieldset>

                <fieldset>
                    <legend><span class="number">2</span>Inovação</legend>
                    <label for="jornada_secao4_inovacao_main_title">Titulo:</label><input type="text" name="jornada_secao4_inovacao_main_title" value="<?php echo get_option_esc('jornada_secao4_inovacao_main_title'); ?>" placeholder="Titulo Principal">
                    <label for="jornada_secao4_inovacao_title">Titulo:</label><input type="text" name="jornada_secao4_inovacao_title" value="<?php echo get_option_esc('jornada_secao4_inovacao_title'); ?>" placeholder="Titulo">
                    <label for="jornada_secao4_inovacao_desc">Descricao:</label> <textarea name="jornada_secao4_inovacao_desc" placeholder="Descrição" ><?php echo get_option_esc('jornada_secao4_inovacao_desc'); ?></textarea>
                    <label for="jornada_secao4_inovacao_desc_pre_cta">Descricao Pré-CTA:</label> <textarea name="jornada_secao4_inovacao_desc_pre_cta" placeholder="Descrição" ><?php echo get_option_esc('jornada_secao4_inovacao_desc_pre_cta'); ?></textarea>
                    <div class="checkbox-degrade"> <input type="checkbox" name="jornada_secao4_inovacao_desc_pre_cta_degrade"> Para Inserir Degradê, Selecione o Texto e Marque Esta Opção </div>

                    <?php
                        //obtendo opções salvas no BD
                        global $wpdb;
                        $cta = json_decode(json_encode($wpdb->get_results('SELECT * FROM ' . $wpdb->prefix . 'd1_call_to_action')), true);
                    ?>
                    ...
                    <label for="jornada_secao4_inovacao_cta">Selecione Opção:</label> <select name="jornada_secao4_inovacao_cta">
