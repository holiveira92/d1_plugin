...
$delete_url         = plugins_url('d1_plugin/templates/objetivos/keyp_delete.php?', 'd1_plugin') . $query_string;
$voltar_url         = "?page=d1_plugin_objetivos&tab=secao2&" . $query_string;
$url_action         = plugins_url('d1_plugin/templates/objetivos/keyp_ajax.php', 'd1_plugin'); 
$data = array(
    ...
    'page'          => !empty($data_bd[0]["page"]) ? $data_bd[0]["page"] : 'objetivos',
...
<body class="animsition">
    ...
    <div class="table-data__tool">
        <div class="table-data__tool-right">
            <?php   
                    $return_url = "?page=d1_plugin_objetivos&tab=mod&";
                    $param = array('path_wp' => ABSPATH, 'id_mod' => $id_segmento, 'url_location' => "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
                    $query_string = http_build_query($param);
            ?>
            <a href="<?php echo $return_url . $query_string ;?>"><button type="button" class="button button-primary">
                <-- Voltar para Objetivo</button></a>
        </div>
    </div>
        <div class="container">
            <div class="row">
                <div class="col form-style-5" id='secao1_content1' style="padding-bottom:0px!important">
                    ...
                    <div class="col form-style-5 middle">
                        ...
                        <input type="hidden" name="page<?php echo D1Plugin::$language; ?>" id="page" value="<?php echo $data['page']; ?>">
                        <input type="hidden" name="id_segmento<?php echo D1Plugin::$language; ?>" id="id_segmento" value="<?php echo $data['id_segmento']; ?>">
