...
<label for="secao7_link_cta_webinario">URL Link CTA Webinário :</label> <input type="text" name="secao7_link_cta_webinario" value="<?php echo get_option_esc('secao7_link_cta_webinario')?>" placeholder="URL Link CTA Webinário">
