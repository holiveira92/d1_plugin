...
<label for="secao2_card1_descricao">Descrição:</label> <textarea name="secao2_card1_descricao" placeholder="Descrição"><?php echo get_option('secao2_card1_descricao')?></textarea>
<label for="secao2_card1_artigo_link">Link Artigo:</label> <textarea name="secao2_card1_artigo_link" placeholder="Link Artigo"><?php echo get_option('secao2_card1_artigo_link')?></textarea>
...
<label for="secao2_card2_descricao">Descrição:</label> <textarea name="secao2_card2_descricao" placeholder="Descrição"><?php echo get_option('secao2_card2_descricao')?></textarea>
<label for="secao2_card2_artigo_link">Link Artigo:</label> <textarea name="secao2_card2_artigo_link" placeholder="Link Artigo"><?php echo get_option('secao2_card2_artigo_link')?></textarea>
...
<label for="secao2_card3_descricao">Descrição:</label> <textarea name="secao2_card3_descricao" placeholder="Descrição"><?php echo get_option('secao2_card3_descricao')?></textarea>
<label for="secao2_card3_artigo_link">Link Artigo:</label> <textarea name="secao2_card3_artigo_link" placeholder="Link Artigo"><?php echo get_option('secao2_card3_artigo_link')?></textarea>
