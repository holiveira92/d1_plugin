...
$delete_url         = plugins_url('d1_plugin/templates/departamentos/keyp_delete.php?', 'd1_plugin') . $query_string;
$voltar_url         = "?page=d1_plugin_departamentos&tab=secao2&" . $query_string;
$url_action         = plugins_url('d1_plugin/templates/departamentos/keyp_ajax.php', 'd1_plugin'); 
$data = array(
    ...
    'page'          => !empty($data_bd[0]["page"]) ? $data_bd[0]["page"] : 'departamentos',
