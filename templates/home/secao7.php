...
<body>
<div class="form-style-5" style='display: flex; flex-wrap: wrap; padding: 20px; background: #f4f7f8; border-radius: 8px; font-family: Georgia,"Times New Roman",Times,serif;'>

<!-- ------------------------------------- Início Seção Config. Seção - Diferencial --------------------------------------->
<!-- Titulo Seção Parte 2 -->
<div id='secao7_content1' class="content" style='flex: 0 45%; padding: 0 2%;'>
<legend><span class="number">1</span>Informações da Seção</legend>
<fieldset>
<label for="secao7_section_title">Titulo :</label> <input type="checkbox" name="secao7_section_title_degrade"> Para Inserir Degradê, Selecione o Texto e Marque Esta Opção <br> <input type="text" name="secao7_section_title" value="<?php echo get_option_esc('secao7_section_title')?>" placeholder="Titulo da Seção">
<label for="secao7_section_descricao">Descrição :</label> <input type="checkbox" name="secao7_section_descricao_degrade"> Para Inserir Degradê, Selecione o Texto e Marque Esta Opção <br><textarea name="secao7_section_descricao" placeholder="Descrição" rows=6><?php echo get_option_esc('secao7_section_descricao')?></textarea>
</div>
</fieldset>

<div id='secao7_content2' class="content" style='flex: 0 45%; padding: 0 2%;'>
