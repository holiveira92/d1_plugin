            ...
            <div class="col form-style-5">
                ...
                <fieldset>
                    ...
                    <div id='secao2_content1' class="content" style='display:block;'>
                        <label for="secao2_title">Titulo da Seção:</label><input type="text" name="secao2_title" value="<?php echo get_option_esc('secao2_title') ?>">-->
                        <label for="secao2_descricao">Descrição da Seção:</label> <textarea name="secao2_descricao"><?php echo get_option_esc('secao2_descricao') ?></textarea>
                </fieldset>
            </div>
        </div>
        <div class="row">
            <div class="col form-style-5">
                ...
                <fieldset>
                    ...
                    <!--<label for="secao2_card1_title">Titulo da Seção:</label><input type="text" name="secao2_card1_title" value="<?php echo get_option_esc('secao2_card1_title') ?>">-->
                    <label for="secao2_card1_descricao">Titulo da Seção:</label> <textarea name="secao2_card1_descricao" rows='4'><?php echo get_option_esc('secao2_card1_descricao') ?></textarea>
                    <label for="secao2_card1_artigo_link">Link Artigo:</label> <textarea name="secao2_card1_artigo_link" rows='1'><?php echo get_option_esc('secao2_card1_artigo_link') ?></textarea>
            ...
            <div class="col form-style-5">
                ...
                <fieldset style='flex: 0 33%; padding: 0 2%;'>
                    ...
                    <!--<label for="secao2_card2_title">Titulo da Seção:</label><input type="text" name="secao2_card2_title" value="<?php echo get_option_esc('secao2_card2_title') ?>">-->
                    <label for="secao2_card2_descricao">Titulo da Seção:</label> <textarea name="secao2_card2_descricao" rows='4'><?php echo get_option_esc('secao2_card2_descricao') ?></textarea>
                    <label for="secao2_card2_artigo_link">Link Artigo:</label> <textarea name="secao2_card2_artigo_link" rows='1'><?php echo get_option_esc('secao2_card2_artigo_link') ?></textarea>
            ...
            <div class="col form-style-5">
                ...
                <fieldset style='flex: 0 33%; padding: 0 2%;;'>
                    ...
                    <!--<label for="secao2_card3_title">Titulo da Seção:</label><input type="text" name="secao2_card3_title" value="<?php echo get_option_esc('secao2_card3_title') ?>">-->
                    <label for="secao2_card3_descricao">Titulo da Seção:</label> <textarea name="secao2_card3_descricao" rows='4'><?php echo get_option_esc('secao2_card3_descricao') ?></textarea>
                    <label for="secao2_card3_artigo_link">Link Artigo:</label> <textarea name="secao2_card3_artigo_link" rows='1'><?php echo get_option_esc('secao2_card3_artigo_link') ?></textarea>
