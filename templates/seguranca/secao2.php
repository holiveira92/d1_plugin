...
<body class="animsition">
    ...
    <div class="table-data__tool">
        <div class="table-data__tool-right">
            <?php   
                    $create_url = "?page=d1_plugin_seguranca&tab=seg&";
    ...
    <div class="table-responsive table-responsive-data2">
        <table class="table table-data2">
            ...
            <tbody>
                <?php 
                    global $wpdb;
                    $result = json_decode(json_encode($wpdb->get_results("SELECT * FROM " . $wpdb->prefix . "d1_seguranca WHERE tipo='seguranca' ")),true);
                    $cont = 0;
                    $delete_url = plugins_url('d1_plugin/templates/seguranca/seg_delete.php?','d1_plugin');
                    foreach($result as $key=>&$value): 
                        $cont++;
                        $create_edit_url = "?page=d1_plugin_seguranca&tab=seg&";
