    ...
    <div class="table-responsive table-responsive-data2">
        <table class="table table-data2">
            ...
            <tbody>
                <?php 
                    global $wpdb;
                    $result = json_decode(json_encode($wpdb->get_results('SELECT * FROM ' . $wpdb->prefix . D1_LANG . 'd1_cases_categorias WHERE id_categoria IS NULL or id_categoria = "" ')),true);
                    $cont = 0;
                ...
                ?>
                <tr class="tr-shadow">
                    <input type="hidden" name="id_categoria" id="id_categoria" value="<?php echo $value['id'];?>">
