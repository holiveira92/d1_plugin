...
$delete_url         = plugins_url('d1_plugin/templates/modulos/keyp_delete.php?', 'd1_plugin') . $query_string;
$voltar_url         = "?page=d1_plugin_modulos&tab=secao2&" . $query_string;
$url_action         = plugins_url('d1_plugin/templates/modulos/keyp_ajax.php', 'd1_plugin'); 
$data = array(
    ...
    'page'          => !empty($data_bd[0]["page"]) ? $data_bd[0]["page"] : 'modulos',
...
<body class="animsition">
    ...
    <div class="table-data__tool">
        <div class="table-data__tool-right">
            <?php   
                    $return_url = "?page=d1_plugin_modulos&tab=mod&";
