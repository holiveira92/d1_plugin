            ...
            <div class="col form-style-5">
                ...
                <fieldset>
                    <legend><span class="number"><?php echo $i;?></span>Itens Especialidade <?php echo $i;?></legend>
                        <label for="contato_secao1_item<?php echo $i;?>_desc">Descricao:</label> <textarea name="contato_secao1_item<?php echo $i;?>_desc" placeholder="Descrição"><?php echo get_option_esc("contato_secao1_item".$i."_desc") ?></textarea>
