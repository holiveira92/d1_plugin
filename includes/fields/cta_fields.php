...
class Cta_Fields {
    ...
    public function getSettings($opt_group=false,$page='d1_plugin_cta'){
		$settings = array();
    ...
    public function getFields($section=false,$page='d1_plugin_cta'){
		$fields = array();
	...
	/* 	----------------------------------------------------------------------------------------------------------------------------
		...
		----------------------------------------------------------------------------------------------------------------------------
	*/ 
    public function d1_Cta_secao1($input){return $input;}
    public function d1_Cta_secao2($input){return $input;}
    public function d1_Cta_secao3($input){return $input;}
    public function d1_Cta_secao4($input){return $input;}
}