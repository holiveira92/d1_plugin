...
<body>
    <?php $url_action = plugins_url('d1_plugin/templates/jornada/faq_ajax.php','d1_plugin'); ?>
    <form id="faq_fields" action="<?php echo $url_action; ?>">
        <div class="form-style-5" id='secao_content'>
            ...
            <?php
            global $wpdb;
            $faqs = json_decode(json_encode($wpdb->get_results('SELECT * FROM ' . $wpdb->prefix . 'd1_faq WHERE page = "jornada" ')), true);
            $cont_faq = 0;
            foreach ($faqs as $key => &$faq) :
                ...
                <fieldset name="d1_faqs<?php echo D1Plugin::$language; ?>" id_faq="<?php echo $faq['id']; ?>">
                    ...
                    <input type="hidden" name="page[]<?php echo D1Plugin::$language; ?>" value="jornada">
