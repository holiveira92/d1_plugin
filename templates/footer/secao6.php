...
<fieldset style='display: inline;margin-right:4%;width:99%;margin-bottom:30px;'>
<label for="secao6_pitch">Pitch Footer:</label> <textarea name="secao6_pitch" placeholder="Pitch Footer" rows=10><?php echo get_option_esc('secao6_pitch')?></textarea>
</fieldset>
<!----------------------------------------------------------------------- Seção 6 - Fim Pitch -------------------------------------------------------------------------->
