...
class Segmentos{
        ...
        switch($this->active_tab){
			...
			case 'seg': 
				$this->sections = array(
					array(
						'id' => 'd1_segmentos_seg',
						'title' => 'Configurações de Segmentos ',
						'callback' => array( $this, 'd1Segmentos' ),
						'page' => $this->page
					),
				);
                break;
	...
	public function d1Segmentos(){require_once plugin_dir_path(dirname_safe(__FILE__,2)) . 'templates/segmentos/segmentos.php';}
}